...
public class CalculatorTest
{
    ...
    */
    ...
    public void PerformOperation_Division_Num1OverNum2()
    {
        ...
        Assert.Throws<DivideByZeroException>(() => _calculator.PerformOperation(5, 0, "divide"));
    }
    ...
    public void PerformOperation_NonNumericInputs_ThrowsFormatException()
    {
        ...
        Assert.Throws<FormatException>(() => _calculator.PerformOperation("five", "three", "add"));
        Assert.Throws<FormatException>(() => _calculator.PerformOperation("ten", "two", "subtract"));
        Assert.Throws<FormatException>(() => _calculator.PerformOperation("one", "one", "multiply"));
    }
    ...
    public void PerformOperation_NullInputs_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() => _calculator.PerformOperation(null, 3, "add"));
        Assert.Throws<ArgumentNullException>(() => _calculator.PerformOperation(5, null, "subtract"));
        Assert.Throws<ArgumentNullException>(() => _calculator.PerformOperation(null, null, "multiply"));
    }
    ...
    {
        Assert.That(_calculator.PerformOperation(5, 1, "divide"), Is.EqualTo((double)5));
        Assert.That(_calculator.PerformOperation(10, 1, "divide"), Is.EqualTo((double)10));
    }

    [Test]
    public void PerformOperation_MultiplyByOne_Unchanged()
    {
        Assert.That(_calculator.PerformOperation(5, 1, "multiply"), Is.EqualTo((double)5));
        Assert.That(_calculator.PerformOperation(10, 1, "multiply"), Is.EqualTo((double)10));
    }
